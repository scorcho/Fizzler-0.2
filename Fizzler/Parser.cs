...
namespace Fizzler
{
    ...
    public sealed class Parser
    {
        ...
        private void Attrib()
        {
            ...
            while (true)
            {
                var op = TryRead(TokenKind.Equals, TokenKind.Includes, TokenKind.DashMatch);
                if(op == null) 
                    break;
                hasValue = true;
    ...
    public class DocumentNodeCompiler : ISelectorGenerator<IDocumentNode>
    {
        /// <summary>FIXDOC</summary>
        public Selector<IDocumentNode> OnInit()
        {
            return nodes => nodes.Where(n => n.IsElement).Distinct().SelectMany(n => n.DescendantsAndSelf());
        }
        ...
        /// <summary>FIXDOC</summary>
        public Selector<IDocumentNode> Type(string type)
        {
            return nodes => nodes.Where(n => n.IsElement && n.Name == type);
        }

        /// <summary>FIXDOC</summary>
        public Selector<IDocumentNode> Universal()
        {
            return nodes => nodes.Where(n => n.IsElement);
        }

        /// <summary>FIXDOC</summary>
        public Selector<IDocumentNode> Id(string id)
        {
            return nodes => nodes.Where(n => n.IsElement && n.Id == id);
        }

        /// <summary>FIXDOC</summary>
        public Selector<IDocumentNode> Class(string clazz)
        {
            return nodes => nodes.Where(n => n.IsElement 
                                          && n.Class != null 
                                          && n.Class.Split(' ').Contains(clazz));
        }
        ...
        /// <summary>FIXDOC</summary>
        public Selector<IDocumentNode> AttributeExists(string name)
        {
            return nodes => nodes.Where(n => n.IsElement && n.Attributes[name] != null);
        }

        /// <summary>FIXDOC</summary>
        public Selector<IDocumentNode> AttributeExact(string name, string value)
        {
        ...
        /// <summary>FIXDOC</summary>
        public Selector<IDocumentNode> AttributeIncludes(string name, string value)
        {
            return nodes => from n in nodes
                            where n.IsElement
                            let a = n.Attributes[name]
        ...
        /// <summary>FIXDOC</summary>
        public Selector<IDocumentNode> AttributeDashMatch(string name, string value)
        {
            return nodes => from n in nodes
                            where n.IsElement
                            let a = n.Attributes[name]
        ...
        /// <summary>FIXDOC</summary>
        public Selector<IDocumentNode> FirstChild()
        {
            return nodes => nodes.Where(n => !n.ElementsBeforeSelf().Any());
        }

        /// <summary>FIXDOC</summary>
        public Selector<IDocumentNode> LastChild()
        {
            return nodes => nodes.Where(n => !n.ElementsAfterSelf().Any());
        }

        /// <summary>FIXDOC</summary>
        public Selector<IDocumentNode> OnlyChild()
        {
            return nodes => nodes.Where(n => !n.ElementsAfterSelf().Concat(n.ElementsBeforeSelf()).Any());
        }

        /// <summary>FIXDOC</summary>
        public Selector<IDocumentNode> Empty()
        {
        ...
        /// <summary>FIXDOC</summary>
        public Selector<IDocumentNode> Child()
        {
            return nodes => nodes.SelectMany(n => n.Elements());
        }

        /// <summary>FIXDOC</summary>
        public Selector<IDocumentNode> Descendant()
        {
            return nodes => nodes.SelectMany(n => n.Descendants());
        }

        /// <summary>FIXDOC</summary>
        public Selector<IDocumentNode> Adjacent()
        {
